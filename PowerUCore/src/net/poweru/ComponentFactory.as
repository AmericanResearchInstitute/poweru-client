package net.poweru
{
	...
	import net.poweru.components.dialogs.CreateEventWizard;
	...
	import net.poweru.components.dialogs.choosers.ChooseLoginContext;
	...
	import net.poweru.presenters.ChooseLoginContextMediator;
	...
	import net.poweru.presenters.CreateEventWizardMediator;
	...
	public class ComponentFactory extends net.poweru.placemanager.ComponentFactory implements IComponentFactory
	{
		...
		override public function getComponent(name:String):DisplayObject
		{
			...
			switch (name)
			{
				...
				case Places.CHOOSELOGINCONTEXT:
					component = getOrCreate(name, ChooseLoginContext, ChooseLoginContextMediator);
					break;
				...
				case Places.CREATEEVENTWIZARD:
					component = getOrCreate(name, CreateEventWizard, CreateEventWizardMediator);
					break;
